...
In questo caso gran parte delle funzioni del middleware, quelle relative alla comunicazione via stack WiFi, è implementato all'interno del sistema a microprocessore (MCU).
